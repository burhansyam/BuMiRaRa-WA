...
def shell():
    ...
    if not args.mini:
        ...
        if args.server and len(args.server) == 1:
            printer('📰 mengambil informasi server...', quiet)
        else:
            printer('🔎 memilih server berdasar ping...', quiet)
    ...
    if args.upload:
        ...
        printer('*🚀 Upload:* %0.2f M%s/s' %
                ((results.upload / 1000.0 / 1000.0) / args.units[1],
                 args.units[0]),
                quiet)
        printer("\n...................................................................................\n▶︎ Uji Kecepatan oleh *OOKLA*\n▶︎ di coding ulang oleh @burhansyam_")
    else:
